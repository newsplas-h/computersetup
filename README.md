...
If a network is unavailable during oobe, you can still use the .ppkg. once a network is connected, either run the task from task scheduler or reboot the machine and the startup scripts will fetch and run.